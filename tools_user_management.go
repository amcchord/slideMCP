...
// handleUserManagementTool handles all user, account, and client-related operations through a single meta-tool
func handleUserManagementTool(args map[string]interface{}) (string, error) {
...
// getUserManagementToolInfo returns the tool definition for the user management meta-tool
		...
		InputSchema: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"user_id": map[string]interface{}{
					"type":        "string",
					"description": "ID of the user - required for get_user operation",
				},
				// Account parameters
