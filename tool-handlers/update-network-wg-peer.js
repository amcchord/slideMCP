...
/**
 * Claude Desktop Tool Handler: slide_update_network_wg_peer
 * This script is executed by Claude Desktop when the slide_update_network_wg_peer tool is called
 */
...
if (args.peer_name) wgPeerData.peer_name = args.peer_name;
...
async function updateNetworkWGPeer() {
  try {
    const result = await slideClient.updateNetworkWGPeer(args.network_id, wgPeerData);
    ...
    const formattedResult = {
      ...
      wg_peer: {
        ...
        updated: {
          ...
          remote_networks: args.remote_networks
        }
      }
    };
