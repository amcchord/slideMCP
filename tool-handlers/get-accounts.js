...
/**
 * Claude Desktop Tool Handler: slide_get_accounts
 * This script is executed by Claude Desktop when the slide_get_accounts tool is called
 */
...
async function getAccounts() {
  try {
    ...
    const result = await slideClient.getAccounts(params);
    ...
    const formattedResult = {
      accounts: result.data.map(account => ({
        ...
        alert_emails: account.alert_emails
      })),
