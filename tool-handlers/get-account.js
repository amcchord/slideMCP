...
/**
 * Claude Desktop Tool Handler: slide_get_account
 * This script is executed by Claude Desktop when the slide_get_account tool is called
 */
...
async function getAccount() {
  try {
    ...
    const result = await slideClient.getAccount(args.account_id);
