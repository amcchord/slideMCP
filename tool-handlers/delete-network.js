...
/**
 * Claude Desktop Tool Handler: slide_delete_network
 * This script is executed by Claude Desktop when the slide_delete_network tool is called
 */
...
async function deleteNetwork() {
  try {
    await slideClient.deleteNetwork(args.network_id);
