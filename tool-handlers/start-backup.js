...
/**
 * Claude Desktop Tool Handler: slide_start_backup
 * This script is executed by Claude Desktop when the slide_start_backup tool is called
 */
...
async function startBackup() {
  try {
    const result = await slideClient.startBackup(backupData);
